        ...
        <div style={{}}>
          ...
          <div style={{fontSize:"26px", width:"700px"}}>
            ...
            <br/>
              ...
              <br/>
              <div style={{marginRight:"20px", textAlign:"left", fontFamily:"Arial, sans-serif"}}>
                <div style={{fontWeight: "bold", paddingBottom: "10px"}}>출발 시간</div><div> : {arrive_time}</div>
                {depart_time!==null?
                  <div>
                    <br/>
                    <div style={{fontWeight: "bold", paddingBottom: "10px"}}>도착 시간</div> : {depart_time}
                  </div>
                  :
                  <div>
                    <br/>
                    <div style={{fontWeight: "bold", paddingBottom: "10px"}}>도착 시간</div> : (출발지입니다.)
                  </div>
                }
                <br/>
                <div style={{fontWeight: "bold", paddingBottom: "10px"}}>이동 시간</div><div> : {move_time}분</div>
                </div>
          </div>
